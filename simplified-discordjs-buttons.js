...
function create_button(style, url, label, disabled, message) {
  let btn = new disbut.MessageButton()
    ...
    if (style === "null" || "NaN" || "undefined" || "none" || !style) {
    btn.setStyle('grey')
    } else {
    btn.setStyle(style)
    }
    ...
    if (url === "null" || "NaN" || "undefined" || "none" || !url) {
    // no link
    } else {
    btn.setURL(url)
    }
    ...
    if (label === "null" || "NaN" || "undefined" || "none" || !label) {
    ...
    if (message === "null" || "NaN" || "undefined" || "none" || !message) {
